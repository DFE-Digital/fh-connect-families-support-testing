describe('| e2e-ManServ_011 | Manage Service - view - Change more Details ',function(){
    it('Change more Details - Salford City Council - Journey - Manage Service - edit ',function(){
         cy.visit('/')
        // start page 
        cy.startPage()
        //sign in page
       ...
       cy.editService('testservice' + n)
        ...
        // edit payment type
        cy.moreDetailsEdit('TestService' + n)
         //more details
        cy.moreDetails('New Test details')
         // check details
        cy.checkDetailsEdit('TestService' + n,'New Test details')
      // manage service 
        cy.ViewServices('TestService' + n)
